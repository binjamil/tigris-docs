...
Alternative ways of installation can be found [here](/docs/sdkstools/cli/installation.mdx).

### Sign up for Tigris Cloud

You will need to have a Tigris Cloud account to complete this quickstart. If
you don't already have an account, you can <a href={tigrisConfig.signupUrl}>sign up for Tigris Cloud</a>.
